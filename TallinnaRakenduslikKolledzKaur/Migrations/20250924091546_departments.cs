        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RomVersion = table.Column<byte>(type: "tinyint", nullable: true),
                    Staplers = table.Column<int>(type: "int", nullable: true),
                    Accomplishments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WastedHours = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
